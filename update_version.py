...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright squeaky-clean-studios, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/eDrumUtil-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/eDrumUtil-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/eDrumUtil-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/eDrumUtil-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/eDrumUtil-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/eDrumUtil-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/eDrumUtil-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/eDrumUtil.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/eDrumUtil.iss",inplace=1):
